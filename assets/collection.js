    ...
    jQuery(document).on('keydown', '.stockist-query-entry .stockist-search-field', function() {
        setTimeout(function() {
    ...
    jQuery(document).on('click', '.stockist-query-entry .stockist-search-field', function() {
        setTimeout(function() {
    ...
    jQuery(document).ready(function() {
        ...
        setTimeout(function() {
            jQuery('.stockist-result-message-text').parents('body').addClass('locator_l_notdata');
        }, 2000);

        setTimeout(function() {

            jQuery('.stockist-list-result .stockist-result-addr-country:contains("US")').hide();
            jQuery('.stockist-map .stockist-result-addr-country:contains("US")').hide();

        }, 3000);

        setTimeout(function() {
            jQuery('#_evh-link, .evidon-banner-message .evidon-banner-acceptbutton').attr('style', '')
    ...
    jQuery(".fr-page-tab").click(function() {
        jQuery('.fr-page-tab').not(jQuery(this)).removeClass('active');
        jQuery('.fr-page-tab-blurb').not(jQuery(this).next()).slideUp();
        jQuery(this).toggleClass('active');
        jQuery(this).next().slideToggle(250);
    });
