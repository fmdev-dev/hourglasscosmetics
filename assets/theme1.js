...
theme1.Sections = function Sections() {
    this.constructors = {};
    this.instances = [];
...
theme1.Sections.prototype = _.assignIn({}, theme1.Sections.prototype, {
...
theme1.Search = (function() {
    ...
    function initDrawer() {
        ...
        theme1.SearchDrawer = new theme1.Drawers('SearchDrawer', 'top', {
    ...
    function searchDrawerFocus() {
        ...
        if ($(selectors.mobileNavWrapper).hasClass(classes.mobileNavIsOpen)) {
            theme1.MobileNav.closeMobileNav();
        }
    }
...
theme1.Slideshow = (function() {
    ...
    function beforeChange(event, slick, currentSlide, nextSlide) {
        ...
        if (isVideoInSlide($currentSlide)) {
            ...
            theme1.SlideshowVideo.pauseVideo(currentVideoId);
        ...
        if (isVideoInSlide($nextSlide)) {
            ...
            if (isBackground) {
                theme1.SlideshowVideo.playVideo(videoId);
            } else {
...
function onYouTubeIframeAPIReady() {
    theme1.SlideshowVideo.loadVideos();
}

theme1.SlideshowVideo = (function() {
...
theme1.customerTemplates = (function() {
...
theme1.HeaderSection = (function() {
    function Header() {
        theme1.Header.init();
        theme1.MobileNav.init();
        theme1.Search.init();
    }

    Header.prototype = _.assignIn({}, Header.prototype, {
        onUnload: function() {
            theme1.Header.unload();
        }
    });
...
theme1.Maps = (function() {
    ...
    var errors = {
        addressNoResults: theme1.strings.addressNoResults,
        addressQueryLimit: theme1.strings.addressQueryLimit,
        addressError: theme1.strings.addressError,
        authError: theme1.strings.authError
    };
...
theme1.Product = (function() {
    ...
    Product.prototype = _.assignIn({}, Product.prototype, {
        _stringOverrides: function() {
            theme1.productStrings = theme1.productStrings || {};
            $.extend(theme1.strings, theme1.productStrings);
        },
        ...
        _liveRegionText: function(variant) {
            ...
            if (!variant) {
                liveRegionText = theme1.strings.unavailable;
                return liveRegionText;
            }

            // Update availability
            var availability = variant.available ? '' : theme1.strings.soldOut + ',';
            liveRegionText = liveRegionText.replace('[Availability]', availability);

            // Update pricing information
            var regularLabel = '';
            var regularPrice = theme1.Currency.formatMoney(
                variant.price,
                theme1.moneyFormat
            );
            var saleLabel = '';
            ...
            if (variant.compare_at_price > variant.price) {
                regularLabel = theme1.strings.regularPrice;
                regularPrice =
                    theme1.Currency.formatMoney(
                        variant.compare_at_price,
                        theme1.moneyFormat
                    ) + ',';
                saleLabel = theme1.strings.sale;
                salePrice = theme1.Currency.formatMoney(
                    variant.price,
                    theme1.moneyFormat
                );
            }
        ...
        _updateAddToCart: function(evt) {
            ...
            if (variant) {
                if (variant.available) {
                    ...
                    $(this.selectors.addToCartText).text(theme1.strings.addToCart);
                    $(this.selectors.shopifyPaymentButton, this.$container).show();
                } else {
                    // The variant doesn't exist, disable submit button and change the text.
                    // This may be an error or notice that a specific variant is not available.
                    $(this.selectors.addToCart).prop('disabled', true);
                    $(this.selectors.addToCartText).text(theme1.strings.soldOut);
                    $(this.selectors.shopifyPaymentButton, this.$container).hide();
                }
            } else {
                $(this.selectors.addToCart).prop('disabled', true);
                $(this.selectors.addToCartText).text(theme1.strings.unavailable);
                $(this.selectors.shopifyPaymentButton, this.$container).hide();
            }
        },
        ...
        _updatePrice: function(evt) {
            ...
            if (variant.compare_at_price > variant.price) {
                ...
                $salePrice.html(
                    theme1.Currency.formatMoney(variant.price, theme1.moneyFormat)
                );
...
theme1.SlideshowSection = (function() {
    function SlideshowSection(container) {
        ...
        $('.slideshow__video', slideshow).each(function() {
            var $el = $(this);
            theme1.SlideshowVideo.init($el);
            theme1.SlideshowVideo.loadVideo($el.attr('id'));
        });

        theme1.slideshows[slideshow] = new theme1.Slideshow(slideshow);
    }

    return SlideshowSection;
})();

theme1.SlideshowSection.prototype = _.assignIn({},
    theme1.SlideshowSection.prototype, {
        onUnload: function() {
            delete theme1.slideshows[this.slideshow];
        },
...
$(document).ready(function() {
    var sections = new theme1.Sections();

    sections.register('cart-template', theme1.Cart);
    sections.register('product', theme1.Product);
    sections.register('collection-template', theme1.Filters);
    sections.register('product-template', theme1.Product);
    sections.register('header-section', theme1.HeaderSection);
    sections.register('map', theme1.Maps);
    sections.register('slideshow-section', theme1.SlideshowSection);
    sections.register('quotes', theme1.Quotes);

    // Sort option selected or not
    $('#SortBy').change(function() {

        var optVal = $(this).val();
        $("#SortBy option[value=optVal]").prop("selected", "selected")
...
theme1.init = function() {
    theme1.customerTemplates.init();
    ...
    slate.a11y.accessibleLinks({
        messages: {
            newWindow: theme1.strings.newWindow,
            external: theme1.strings.external,
            newWindowExternal: theme1.strings.newWindowExternal
        },
        $links: $('a:not([aria-describedby], .product-single__thumbnail)')
    });

    theme1.FormStatus.init();
};
